...
class _DiveMasterInboxPageState extends State<DiveMasterInboxPage> {
  ...
  final deployedContract = DeployedContract(
    ...
    EthereumAddress.fromHex('0x8D332262a250fF0541BB862C52d95d78B6532C03'),
  );
  ...
  Future<void> _confirmMessage(Message _message) async {
    ...
    try {
      final result = await _w3mService.requestWriteContract(
        ...
        parameters: [
          EthereumAddress.fromHex(_message.sender),
          BigInt.from(_message.id),
          _message.location
        ],
      ).whenComplete(()=>print("denedik")).timeout(Duration(seconds: 60), onTimeout: () {
        throw TimeoutException('Transaction took too long');
      });

      print('NFT mint success: $result');
